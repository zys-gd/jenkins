					...
					script {
						try {
							sh '''
								...
								docker-compose exec -T mysql echo "CREATE DATABASE IF NOT EXISTS toplivo_tracking;GRANT ALL PRIVILEGES ON toplivo_tracking.* TO toplivo_user" | mysql -u root -proot123456
